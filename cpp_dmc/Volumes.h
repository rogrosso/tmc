...
namespace cpp_mc {
	 ...
	 */
     ...
     {
         auto square = [](const double v) { return v*v; };
...
#pragma omp parallel for
		...
		/** push out of the Volmes class the definition of the 3D scalar functions
         * this is required to compile with the gcc compiler.
        template<Surface T>
		double surface(const double x, const double y, const double z)
		{
			return x * x + y * y + z * z;
